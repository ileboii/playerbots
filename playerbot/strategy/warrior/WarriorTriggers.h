...
namespace ai
{
    ...
    public:
        ...
        bool IsActive() override
        {
            ...
            return SpellCanBeCastedTrigger::IsActive();
#else
            bool hasTalents = bot->HasSpell(12294) || bot->HasSpell(21551) || bot->HasSpell(21552) || bot->HasSpell(21553) || bot->HasSpell(23881) || bot->HasSpell(23892) || bot->HasSpell(23893) || bot->HasSpell(23894);
